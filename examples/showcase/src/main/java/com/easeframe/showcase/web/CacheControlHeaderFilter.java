package com.easeframe.showcase.web;
...
import com.easeframe.core.web.ServletUtil;
 ...
 * 		<filter-class>com.easeframe.showcase.web.CacheControlHeaderFilter</filter-class> 
 * 		<init-param>
...
public class CacheControlHeaderFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res,
		...
		ServletUtil.setExpiresHeader((HttpServletResponse) res, expiresSeconds);
