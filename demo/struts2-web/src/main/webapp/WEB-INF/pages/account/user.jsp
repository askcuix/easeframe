...
<div>
			...
			<s:if test="page.hasPrePage"><a href="javascript:jumpPage(${page.prePage})">上一页</a></s:if>
			<s:if test="page.hasNextPage"><a href="javascript:jumpPage(${page.nextPage})">下一页</a></s:if>
