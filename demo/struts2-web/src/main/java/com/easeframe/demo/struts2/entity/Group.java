package com.easeframe.demo.struts2.entity;
...
public class Group extends IdEntity {
	...
	@ManyToMany
	@JoinTable(name = "DS2_GROUP_PERMISSION", joinColumns = { @JoinColumn(name = "GROUP_ID") }, inverseJoinColumns = { @JoinColumn(name = "PERMISSION_ID") })
