...
public class GroupDaoTest extends SpringTxTestCase {
	...
	public void deleteRole() {
		...
		int oldJoinTableCount = countRowsInTable("DS2_USER_GROUP");
		int oldUserTableCount = countRowsInTable("DS2_USER");

		//删除用户权限组, 中间表将减少1条记录,而用户表应该不受影响.
		groupDao.delete(group.getId());
		groupDao.flush();

		int newJoinTableCount = countRowsInTable("DS2_USER_GROUP");
		int newUserTableCount = countRowsInTable("DS2_USER");
